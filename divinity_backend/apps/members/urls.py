...
from .views import (
    ActivatePortalAccessView,
    ApplyRecommendedFieldConfigView,
    CustomFieldViewSet,
    FieldConfigViewSet,
    MemberViewSet,
)
...
member_portal_access = ActivatePortalAccessView.as_view()
...
field_config_apply_recommended = ApplyRecommendedFieldConfigView.as_view()
...
urlpatterns = [
    ...
    path('<int:pk>/portal-access/', member_portal_access, name='member-portal-access'),
    ...
    path('field-config/apply-recommended/', field_config_apply_recommended, name='field-config-apply-recommended'),
