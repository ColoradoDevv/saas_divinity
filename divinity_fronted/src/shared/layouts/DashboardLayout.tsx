...
const ALL_NAV = [
  ...
  { to: '/members',    label: 'Miembros',       module: 'members',  adminOnly: false },
  ...
  { to: '/classes',    label: 'Clases',         module: 'classes',  adminOnly: false },
      ...
      {role === 'admin' && (
        <>
          ...
          <nav className="space-y-0.5 px-3" aria-label="Configuración">
            ...
            {enabledModules.includes('payments') && organization?.business_type === 'gym' && (
              <NavLink
                to="/settings/plans"
                onClick={onClose}
                className={({ isActive }) =>
            ...
            {enabledModules.includes('biometric_devices') && (
              <NavLink
                to="/settings/devices"
                onClick={onClose}
                className={({ isActive }) =>
              ...
              >
                <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  ...
                  <path d="M12 21c-3-3-6-6.5-6-10a6 6 0 0 1 12 0c0 3.5-3 7-6 10z" />
                </svg>
